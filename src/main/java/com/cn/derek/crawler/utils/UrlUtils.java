package com.cn.derek.crawler.utils;
...
public class UrlUtils
{
	 ...
	 * 匹配超链接的正则表达式
	 */
	private static String pat = "http[s]?://.*/.*";
	private static String legalChar = "[\\d]";
     ...
     * @return
     */
    public static String replaceIllegalChacter(String url){
 	   String[] strs = url.split("#") ;
 	   url = strs[0] ;
 	   return url.replace("%", "%25").replace("~", "%7").replace(" ", "%20") ;
    }
	/**
	 * 判断是否创建文件
	 * 
